...
```
NEW ALERT: https://github.com/yadavnikhil17102004/CVE_Map_hehe/tree/main/{year}/{cve-name}
```
...
2. Add the webhook URL to GitHub:
   - Go to `https://github.com/yadavnikhil17102004/CVE_Map_hehe/settings/environments`
